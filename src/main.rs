                ...
                match mode_now {
                    VaultMode::Idle => {
                        ...
                        if s_lower_g.starts_with("http://") || s_lower_g.starts_with("https://") {
                            ...
                            // Not a URL. This used to be the gene-exchange path: base45 decode,
                            // AES-GCM-SIV decrypt, and a reply gene encoded back out. Gene
                            // exchange was dropped from this badge, so the code was dead weight
