...
impl ActionManager {
    pub fn new(
        ...
        #[cfg(feature = "board-baosec")]
        let rtc_conn = {
            // The RTC server (TIME_SERVER_PUBLIC) is registered by bao1x-hal-service, which may
            // not have run yet when ActionManager is constructed. Wait for it rather than
